...
/**
 * Manual modifications go to {org.ow2.fractal.mind.xtext.FractalUiModule}
 */
public abstract class AbstractFractalUiModule extends FractalRuntimeModule {
	...
	public void configureHighlightingLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.core.LexerUIBindings.HIGHLIGHTING)).to(org.ow2.fractal.mind.xtext.parser.antlr.internal.InternalFractalLexer.class);
	}
	...
	public Class<? extends org.eclipse.xtext.validation.IssueResolutionProvider> bindIssueResolutionProvider() {
		return org.ow2.fractal.mind.xtext.quickfix.FractalQuickfixProvider.class;
	}

	// contributed by org.eclipse.xtext.ui.generator.labeling.LabelProviderFragment
	public Class<? extends org.eclipse.jface.viewers.ILabelProvider> bindILabelProvider() {
		return org.ow2.fractal.mind.xtext.labeling.FractalLabelProvider.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.common.editor.outline.transformer.ISemanticModelTransformer> bindISemanticModelTransformer() {
		return org.ow2.fractal.mind.xtext.outline.FractalTransformer.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.common.editor.outline.actions.IContentOutlineNodeAdapterFactory> bindIContentOutlineNodeAdapterFactory() {
		return org.ow2.fractal.mind.xtext.outline.FractalOutlineNodeAdapterFactory.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.core.editor.contentassist.IContentProposalProvider> bindIContentProposalProvider() {
		return org.ow2.fractal.mind.xtext.contentassist.FractalProposalProvider.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.common.editor.contentassist.antlr.IContentAssistParser> bindIContentAssistParser() {
		return org.ow2.fractal.mind.xtext.contentassist.antlr.FractalParser.class;
	}

	// contributed by de.itemis.xtext.antlr.XtextAntlrUiGeneratorFragment
	public void configureContentAssistLexerProvider(com.google.inject.Binder binder) {
		binder.bind(org.ow2.fractal.mind.xtext.contentassist.antlr.internal.InternalFractalLexer.class).toProvider(org.eclipse.xtext.parser.antlr.LexerProvider.create(org.ow2.fractal.mind.xtext.contentassist.antlr.internal.InternalFractalLexer.class));
	}

	// contributed by de.itemis.xtext.antlr.XtextAntlrUiGeneratorFragment
	public void configureContentAssistLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.ui.common.editor.contentassist.antlr.internal.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.core.LexerUIBindings.CONTENT_ASSIST)).to(org.ow2.fractal.mind.xtext.contentassist.antlr.internal.InternalFractalLexer.class);
	}
