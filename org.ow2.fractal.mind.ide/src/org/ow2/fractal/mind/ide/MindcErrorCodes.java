...
public class MindcErrorCodes {
	...
	public static final int MADL_DO_NOT_OVERRIDE = 19;
	public static final int MADL_DUPLICATED_ARGUMENT_VARIABLE_NAME = 33;
	public static final int MADL_DUPLICATED_ATTRIBUTE_NAME = 24;
	public static final int MADL_DUPLICATED_TEMPALTE_VARIABLE_NAME = 14;
	public static final int MADL_INCOMPATIBLE_ARGUMENT_TYPE = 34;
	public static final int MADL_INCOMPATIBLE_ARGUMENT_VALUE = 35;
	public static final int MADL_INCOMPATIBLE_ATTRIBUTE_VALUE = 36;
	public static final int MADL_INSTANTIATE_ARGUMENT_DEFINIITON = 47;
	public static final int MADL_INSTANTIATE_TEMPLATE_DEFINIITON = 46;
	public static final int MADL_INSTANTIATE_TYPE_DEFINIITON = 45;
	public static final int MADL_INVALID_ANY_TEMPLATE_VALUE = 10;
	public static final int MADL_INVALID_ATTRIBUTE_MISSING_TYPE = 22;
	public static final int MADL_INVALID_ATTRIBUTE_OVERRIDE_INHERITED_ATTRIBUTE_TYPE = 21;
	public static final int MADL_INVALID_ATTRIBUTE_VALUE_INCOMPATIBLE_TYPE = 23;
	public static final int MADL_INVALID_DEFINITION_NAME = 0;
	public static final int MADL_INVALID_EXTENDS_COMPOSITE_EXTENDS_PRIMITIVE = 40;
	public static final int MADL_INVALID_EXTENDS_PRIMITIVE_EXTENDS_COMPOSITE = 39;
	public static final int MADL_INVALID_EXTENDS_TYPE_EXTENDS_COMPOSITE = 38;
	public static final int MADL_INVALID_EXTENDS_TYPE_EXTENDS_PRIMITIVE = 37;
	public static final int MADL_INVALID_FACTORY_OF_ABSTRACT = 42;
	public static final int MADL_INVALID_FACTORY_OF_REFERENCED_SINGLETON = 43;
	public static final int MADL_INVALID_FACTORY_OF_SINGLETON = 41;
	public static final int MADL_INVALID_INTERFACE_NAME_OVERRIDE_INHERITED_INTERFACE = 20;
	public static final int MADL_INVALID_PATH = 25;
	public static final int MADL_INVALID_REFERENCE_ANY_TEMPLATE_VALUE = 9;
	public static final int MADL_INVALID_REFERENCE_FOR_SUB_COMPONENT = 4;
	public static final int MADL_INVALID_REFERENCE_MISSING_ARGUMENT = 29;
	public static final int MADL_INVALID_REFERENCE_MISSING_TEMPLATE_VALUE = 7;
	public static final int MADL_INVALID_REFERENCE_NOT_A_COMPOSITE = 2;
	public static final int MADL_INVALID_REFERENCE_NOT_A_PRIMITIVE = 3;
	public static final int MADL_INVALID_REFERENCE_NOT_A_TYPE = 1;
	public static final int MADL_INVALID_REFERENCE_NO_PARAMETER = 28;
	public static final int MADL_INVALID_REFERENCE_NO_SUCH_PARAMETER = 31;
	public static final int MADL_INVALID_REFERENCE_NO_SUCH_TEMPLATE_VARIABLE = 11;
	public static final int MADL_INVALID_REFERENCE_NO_TEMPLATE_VARIABLE = 12;
	public static final int MADL_INVALID_REFERENCE_TOO_MANY_ARGUMENT = 30;
	public static final int MADL_INVALID_REFERENCE_TOO_MANY_TEMPLATE_VALUE = 8;
	public static final int MADL_INVALID_SUB_COMPONENT = 5;
	public static final int MADL_INVALID_SUB_COMPONENT_DUPLICATE_SINGLETON = 6;
	public static final int MADL_INVALID_TEMPLATE_VALUE_CLIENT_INTERFACE_MUST_BE_OPTIONAL = 18;
	public static final int MADL_INVALID_TEMPLATE_VALUE_MISSING_CLIENT_INTERFACE = 17;
	public static final int MADL_INVALID_TEMPLATE_VALUE_MISSING_SERVER_INTERFACE = 16;
	public static final int MADL_INVALID_TEMPLATE_VALUE_TYPE_DEFINITON = 15;
	public static final int MADL_MISSING_SOURCE = 27;
	public static final int MADL_SINGLETON_WITH_DIFFERENT_NAME = 44;
	public static final int MADL_SOURCE_NOT_FOUND = 26;
	public static final int MADL_UNDEFINED_PARAMETER = 32;
	public static final int MADL_UNDEFINED_TEMPALTE_VARIABLE = 13;
	public static final int MADL_UNKNOWN_IMPORT = 48;
