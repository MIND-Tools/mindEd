		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTemplateReferenceAccess().getAlternatives_1(), "rule__TemplateReference__Alternatives_1");
					...
					put(grammarAccess.getCompositeDefinitionAccess().getGroup_2(), "rule__CompositeDefinition__Group_2__0");
					put(grammarAccess.getCompositeDefinitionAccess().getGroup_2_1(), "rule__CompositeDefinition__Group_2_1__0");
					put(grammarAccess.getCompositeDefinitionAccess().getGroup_2_1_1(), "rule__CompositeDefinition__Group_2_1_1__0");
					put(grammarAccess.getCompositeDefinitionAccess().getGroup_4(), "rule__CompositeDefinition__Group_4__0");
					put(grammarAccess.getCompositeDefinitionAccess().getGroup_4_2(), "rule__CompositeDefinition__Group_4_2__0");
					...
					put(grammarAccess.getPrimitiveDefinitionAccess().getGroup_4_2(), "rule__PrimitiveDefinition__Group_4_2__0");
					...
					put(grammarAccess.getCompositeSuperTypeAccess().getGroup_2(), "rule__CompositeSuperType__Group_2__0");
					put(grammarAccess.getCompositeSuperTypeAccess().getGroup_2_2(), "rule__CompositeSuperType__Group_2_2__0");
					...
					put(grammarAccess.getTemplateReferenceAccess().getGroup_0(), "rule__TemplateReference__Group_0__0");
					put(grammarAccess.getTemplateReferenceAccess().getGroup_2(), "rule__TemplateReference__Group_2__0");
					put(grammarAccess.getTemplateReferenceAccess().getGroup_2_2(), "rule__TemplateReference__Group_2_2__0");
					put(grammarAccess.getTemplateReferenceAccess().getGroup_3(), "rule__TemplateReference__Group_3__0");
					put(grammarAccess.getTemplateReferenceAccess().getGroup_3_2(), "rule__TemplateReference__Group_3_2__0");
					...
					put(grammarAccess.getAttributeDefinitionAccess().getGroup_2(), "rule__AttributeDefinition__Group_2__0");
					...
					put(grammarAccess.getCompositeDefinitionAccess().getTemplateSpecifiersAssignment_2_1_0(), "rule__CompositeDefinition__TemplateSpecifiersAssignment_2_1_0");
					put(grammarAccess.getCompositeDefinitionAccess().getTemplateSpecifiersAssignment_2_1_1_1(), "rule__CompositeDefinition__TemplateSpecifiersAssignment_2_1_1_1");
					...
					put(grammarAccess.getCompositeDefinitionAccess().getSuperTypesAssignment_4_1(), "rule__CompositeDefinition__SuperTypesAssignment_4_1");
					put(grammarAccess.getCompositeDefinitionAccess().getSuperTypesAssignment_4_2_1(), "rule__CompositeDefinition__SuperTypesAssignment_4_2_1");
					...
					put(grammarAccess.getPrimitiveDefinitionAccess().getSuperTypesAssignment_4_1(), "rule__PrimitiveDefinition__SuperTypesAssignment_4_1");
					put(grammarAccess.getPrimitiveDefinitionAccess().getSuperTypesAssignment_4_2_1(), "rule__PrimitiveDefinition__SuperTypesAssignment_4_2_1");
					...
					put(grammarAccess.getCompositeSuperTypeAccess().getTemplatesListAssignment_1_1(), "rule__CompositeSuperType__TemplatesListAssignment_1_1");
					put(grammarAccess.getCompositeSuperTypeAccess().getTemplatesListAssignment_1_2_1(), "rule__CompositeSuperType__TemplatesListAssignment_1_2_1");
					put(grammarAccess.getCompositeSuperTypeAccess().getArgumentsListAssignment_2_1(), "rule__CompositeSuperType__ArgumentsListAssignment_2_1");
					put(grammarAccess.getCompositeSuperTypeAccess().getArgumentsListAssignment_2_2_1(), "rule__CompositeSuperType__ArgumentsListAssignment_2_2_1");
					...
					put(grammarAccess.getTemplateReferenceAccess().getTypeReferenceAssignment_1_0(), "rule__TemplateReference__TypeReferenceAssignment_1_0");
					put(grammarAccess.getTemplateReferenceAccess().getAnyTypeReferenceAssignment_1_1(), "rule__TemplateReference__AnyTypeReferenceAssignment_1_1");
					put(grammarAccess.getTemplateReferenceAccess().getTemplatesListAssignment_2_1(), "rule__TemplateReference__TemplatesListAssignment_2_1");
					put(grammarAccess.getTemplateReferenceAccess().getTemplatesListAssignment_2_2_1(), "rule__TemplateReference__TemplatesListAssignment_2_2_1");
					put(grammarAccess.getTemplateReferenceAccess().getArgumentsListAssignment_3_1(), "rule__TemplateReference__ArgumentsListAssignment_3_1");
					put(grammarAccess.getTemplateReferenceAccess().getArgumentsListAssignment_3_2_1(), "rule__TemplateReference__ArgumentsListAssignment_3_2_1");
					...
					put(grammarAccess.getAttributeDefinitionAccess().getHeaderFileAssignment_2_0(), "rule__AttributeDefinition__HeaderFileAssignment_2_0");
					put(grammarAccess.getAttributeDefinitionAccess().getCTypeAssignment_3(), "rule__AttributeDefinition__CTypeAssignment_3");
					put(grammarAccess.getAttributeDefinitionAccess().getTypeAssignment_4(), "rule__AttributeDefinition__TypeAssignment_4");
					put(grammarAccess.getAttributeDefinitionAccess().getNameAssignment_5(), "rule__AttributeDefinition__NameAssignment_5");
					put(grammarAccess.getAttributeDefinitionAccess().getValueAssignment_6_1(), "rule__AttributeDefinition__ValueAssignment_6_1");
