...
import org.ow2.fractal.mind.idl.FractalItfRuntimeModule;

/**
 * Manual modifications go to {org.ow2.fractal.mind.idl.FractalItfUiModule}
 */
public abstract class AbstractFractalItfUiModule extends FractalItfRuntimeModule {
	...
	public void configureHighlightingLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.core.LexerUIBindings.HIGHLIGHTING)).to(org.ow2.fractal.mind.idl.parser.antlr.internal.InternalFractalItfLexer.class);
	}
	...
	public Class<? extends org.eclipse.jface.viewers.ILabelProvider> bindILabelProvider() {
		return org.ow2.fractal.mind.idl.labeling.FractalItfLabelProvider.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.common.editor.outline.transformer.ISemanticModelTransformer> bindISemanticModelTransformer() {
		return org.ow2.fractal.mind.idl.outline.FractalItfTransformer.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.common.editor.outline.actions.IContentOutlineNodeAdapterFactory> bindIContentOutlineNodeAdapterFactory() {
		return org.ow2.fractal.mind.idl.outline.FractalItfOutlineNodeAdapterFactory.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.core.editor.contentassist.IContentProposalProvider> bindIContentProposalProvider() {
		return org.ow2.fractal.mind.idl.contentassist.FractalItfProposalProvider.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.common.editor.contentassist.antlr.IContentAssistParser> bindIContentAssistParser() {
		return org.ow2.fractal.mind.idl.contentassist.antlr.FractalItfParser.class;
	}

	// contributed by de.itemis.xtext.antlr.XtextAntlrUiGeneratorFragment
	public void configureContentAssistLexerProvider(com.google.inject.Binder binder) {
		binder.bind(org.ow2.fractal.mind.idl.contentassist.antlr.internal.InternalFractalItfLexer.class).toProvider(org.eclipse.xtext.parser.antlr.LexerProvider.create(org.ow2.fractal.mind.idl.contentassist.antlr.internal.InternalFractalItfLexer.class));
	}

	// contributed by de.itemis.xtext.antlr.XtextAntlrUiGeneratorFragment
	public void configureContentAssistLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.ui.common.editor.contentassist.antlr.internal.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.core.LexerUIBindings.CONTENT_ASSIST)).to(org.ow2.fractal.mind.idl.contentassist.antlr.internal.InternalFractalItfLexer.class);
	}
