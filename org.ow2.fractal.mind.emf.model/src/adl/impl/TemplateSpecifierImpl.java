 ...
 *   <li>{@link adl.impl.TemplateSpecifierImpl#getSegments <em>Segments</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TemplateSpecifierImpl extends EObjectImpl implements TemplateSpecifier {
	...
	public String getComponentTypeName() {
		...
		if(segments!=null && !segments.isEmpty())
		{
			...
			segments.clear();
			componentTypeName=tmpName+componentTypeName;
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case AdlPackage.TEMPLATE_SPECIFIER__NAME:
				return getName();
			case AdlPackage.TEMPLATE_SPECIFIER__SEGMENTS:
				return getSegments();
		}
