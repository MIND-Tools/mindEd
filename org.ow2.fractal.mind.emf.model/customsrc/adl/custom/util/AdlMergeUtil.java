...
public class AdlMergeUtil extends AbstractMergeTreatment {
	 ...
	 * @author proustr
	 */
	public boolean isValidDefinitionForMerge(ArchitectureDefinition MainComponent, ComponentReference DefinitionReference) {
		if (DefinitionReference == null) return false;
		String DefinitionCallToCheck = DefinitionReference.getNameFQN();
		ArrayList<String> importsList = new ArrayList<String>();
