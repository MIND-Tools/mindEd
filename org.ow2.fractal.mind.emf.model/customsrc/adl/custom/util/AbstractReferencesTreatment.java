...
public abstract class AbstractReferencesTreatment extends EContentAdapter{
	...
	protected CompositeComponentDefinitionCustomImpl getMainComponent(
    	...
    	{
	    	if(((AdlDefinition)testcomponent).getArchitecturedefinition()!=null)
	    	{
	    		return (CompositeComponentDefinitionCustomImpl) ((AdlDefinition)testcomponent).getArchitecturedefinition();
	    	}
    	}
    	return null;
	}
