...
public class ArchitectureDefinitionAdapter extends AbstractReferencesTreatment {
	...
	public void notifyChanged(Notification notification) {
		...
		if (notification.getNotifier() instanceof ArchitectureDefinition
				&& (notification.getFeatureID(ArchitectureDefinition.class) == AdlPackage.ARCHITECTURE_DEFINITION__ELEMENTS || notification
						.getFeatureID(SubComponentDefinition.class) == AdlPackage.ARCHITECTURE_DEFINITION__REFERENCE_DEFINITION)
				&& notification.getEventType() == Notification.SET) {
