...
public class CompositeComponentReferenceAdapter extends ComponentReferenceAdapter {
     ...
     */
 	public void notifyChanged(Notification notification) {
    	...
    	if(
    		(notification.getNotifier() instanceof TemplateDefinition) ||
    		(notification.getNotifier() instanceof CompositeReferenceDefinition 
    				&& notification.getEventType()==Notification.REMOVE 
    				&& notification.getFeatureID(CompositeReferenceDefinition.class)==AdlPackage.COMPOSITE_REFERENCE_DEFINITION__TEMPLATES_LIST
    		))
    	{
