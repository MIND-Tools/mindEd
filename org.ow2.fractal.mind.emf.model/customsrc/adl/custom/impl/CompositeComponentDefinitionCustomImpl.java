 ...
 * <ul>
 * <li>{@link adl.custom.impl.CompositeComponentDefinitionCustomImpl#getActiveDefinitionCallsList <em>getActiveDefinitionCallsList</em>}</li>
 * <li>{@link adl.custom.impl.CompositeComponentDefinitionCustomImpl#getHelper <em>getHelper</em>}</li>
 * <li>{@link adl.custom.impl.CompositeComponentDefinitionCustomImpl#setActiveDefinitionCallsList <em>setActiveDefinitionCallsList</em>}</li>
 * <li>{@link adl.custom.impl.CompositeComponentDefinitionCustomImpl#setName <em>setName</em>}</li>
 * </ul>
 * </p>
 * 
 * @author proustr
