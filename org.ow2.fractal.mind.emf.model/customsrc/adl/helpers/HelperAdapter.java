...
implements IHelper<T>{
	...
	{
		for(EObject nObject=getObject();nObject!=null;nObject=nObject.eContainer())
		{
			if(nObject instanceof ArchitectureDefinition)
			{
				ParentComponent = (ArchitectureDefinition) nObject;
				return;
			}
		}
