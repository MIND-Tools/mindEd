...
public class CompartmentCompositeAnonymousSubComponentBodyCustomCanonicalEditPolicy
		extends
		CompositeAnonymousSubComponentCompartmentCompositeAnonymousSubBodyCanonicalEditPolicy {
	...
	protected String getFactoryHint(IAdaptable elementAdapter) {
		// Workaround for bug https://bugs.eclipse.org/bugs/show_bug.cgi?id=281014
	...
	protected List<View> getViewChildren() {
		// To override getViewChildren(View view)
	...
	protected List<View> getViewChildren(View view) {
        ...
        for(View child : (EList<View>)view.getChildren()) {
            if (child instanceof Node
        		...
        		// Check that the element type did not change
        		// Else delete the view to allow refresh to create a new one
