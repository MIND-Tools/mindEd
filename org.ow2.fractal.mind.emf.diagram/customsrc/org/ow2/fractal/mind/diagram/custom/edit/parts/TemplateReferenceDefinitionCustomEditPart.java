...
import adl.diagram.edit.parts.CompositeReferenceDefinitionCompartmentTemplateReferenceAreaEditPart;
...
public class TemplateReferenceDefinitionCustomEditPart extends
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof CompositeReferenceDefinitionCompartmentTemplateReferenceAreaEditPart) {
			IFigure pane = getPrimaryShape().getArea();
			setupContentPane(pane);
			pane.add(((CompositeReferenceDefinitionCompartmentTemplateReferenceAreaEditPart) childEditPart)
							.getFigure());
			// To open the referenced definition on double clic
			childEditPart.installEditPolicy(EditPolicyRoles.OPEN_ROLE, new OpenDefinitionEditPolicy());
			return true;
