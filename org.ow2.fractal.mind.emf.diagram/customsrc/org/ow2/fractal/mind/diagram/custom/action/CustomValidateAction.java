package org.ow2.fractal.mind.diagram.custom.action;
...
import adl.diagram.part.ValidateAction;
import adl.diagram.providers.MindMarkerNavigationProvider;
import adl.diagram.providers.MindValidationProvider;
...
public class CustomValidateAction extends ValidateAction {
	...
	public CustomValidateAction(IWorkbenchPage initPage) {
		super(initPage);
		page = initPage;
	}
