 ...
 * <ul>
 *   <li>{@link fractalIDL.TypedefSpecification#getQualifedType <em>Qualifed Type</em>}</li>
 *   <li>{@link fractalIDL.TypedefSpecification#getDec <em>Dec</em>}</li>
 * </ul>
 * </p>
 *
 * @see fractalIDL.FractalIDLPackage#getTypedefSpecification()
 * @model
 * @generated
 */
public interface TypedefSpecification extends TypeDefinition
{
   ...
   * @see fractalIDL.FractalIDLPackage#getTypedefSpecification_QualifedType()
  ...
  /**
   * Sets the value of the '{@link fractalIDL.TypedefSpecification#getQualifedType <em>Qualifed Type</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fractalIDL.FractalIDLPackage#getTypedefSpecification_Dec()
   * @model containment="true"
   * @generated
   */
  Declarators getDec();
  ...
  /**
   * Sets the value of the '{@link fractalIDL.TypedefSpecification#getDec <em>Dec</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
