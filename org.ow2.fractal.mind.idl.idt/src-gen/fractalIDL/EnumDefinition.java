 ...
 * <ul>
 *   <li>{@link fractalIDL.EnumDefinition#getEnumMemberList <em>Enum Member List</em>}</li>
 * </ul>
 * </p>
 *
 * @see fractalIDL.FractalIDLPackage#getEnumDefinition()
 * @model
 * @generated
 */
public interface EnumDefinition extends EnumSpecification
{
   ...
   * @see fractalIDL.FractalIDLPackage#getEnumDefinition_EnumMemberList()
  ...
  /**
   * Sets the value of the '{@link fractalIDL.EnumDefinition#getEnumMemberList <em>Enum Member List</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
