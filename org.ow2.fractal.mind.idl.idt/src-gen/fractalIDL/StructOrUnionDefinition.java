 ...
 * <ul>
 *   <li>{@link fractalIDL.StructOrUnionDefinition#getStructMember <em>Struct Member</em>}</li>
 * </ul>
 * </p>
 *
 * @see fractalIDL.FractalIDLPackage#getStructOrUnionDefinition()
 * @model
 * @generated
 */
public interface StructOrUnionDefinition extends StructOrUnionSpecification
{
   ...
   * The list contents are of type {@link fractalIDL.StructMember}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see fractalIDL.FractalIDLPackage#getStructOrUnionDefinition_StructMember()
