...
public class FractalIdtStandaloneSetup implements ISetup {
	...
	public Injector createInjectorAndDoEMFRegistration() {
		org.ow2.fractal.mind.idl.FractalItfStandaloneSetup.doSetup();
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.ow2.fractal.mind.idl.FractalIdtRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.ow2.org/fractal/mind/idl/FractalIdt")) {
		EPackage.Registry.INSTANCE.put("http://www.ow2.org/fractal/mind/idl/FractalIdt", org.ow2.fractal.mind.idl.fractalIdt.FractalIdtPackage.eINSTANCE);
	}
