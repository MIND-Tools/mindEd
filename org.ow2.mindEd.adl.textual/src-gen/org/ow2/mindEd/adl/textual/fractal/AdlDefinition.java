 ...
 *   <li>{@link org.ow2.mindEd.adl.textual.fractal.AdlDefinition#getAnnotationsList <em>Annotations List</em>}</li>
...
public interface AdlDefinition extends EObject
{
   ...
   * @see org.ow2.mindEd.adl.textual.fractal.FractalPackage#getAdlDefinition_AnnotationsList()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.ow2.mindEd.adl.textual.fractal.AdlDefinition#getAnnotationsList <em>Annotations List</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
