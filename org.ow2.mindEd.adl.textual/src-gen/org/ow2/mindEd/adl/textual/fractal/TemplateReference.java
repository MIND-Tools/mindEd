 ...
 * <ul>
 *   <li>{@link org.ow2.mindEd.adl.textual.fractal.TemplateReference#getName <em>Name</em>}</li>
 *   <li>{@link org.ow2.mindEd.adl.textual.fractal.TemplateReference#getTypeReference <em>Type Reference</em>}</li>
 *   <li>{@link org.ow2.mindEd.adl.textual.fractal.TemplateReference#isAnyTypeReference <em>Any Type Reference</em>}</li>
 *   <li>{@link org.ow2.mindEd.adl.textual.fractal.TemplateReference#getTemplatesList <em>Templates List</em>}</li>
 *   <li>{@link org.ow2.mindEd.adl.textual.fractal.TemplateReference#getArgumentsList <em>Arguments List</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.ow2.mindEd.adl.textual.fractal.FractalPackage#getTemplateReference()
 * @model
 * @generated
 */
public interface TemplateReference extends EObject
{
   ...
   * @see org.ow2.mindEd.adl.textual.fractal.FractalPackage#getTemplateReference_Name()
  ...
  /**
   * Sets the value of the '{@link org.ow2.mindEd.adl.textual.fractal.TemplateReference#getName <em>Name</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.ow2.mindEd.adl.textual.fractal.FractalPackage#getTemplateReference_TypeReference()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.ow2.mindEd.adl.textual.fractal.TemplateReference#getTypeReference <em>Type Reference</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.ow2.mindEd.adl.textual.fractal.FractalPackage#getTemplateReference_AnyTypeReference()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.ow2.mindEd.adl.textual.fractal.TemplateReference#isAnyTypeReference <em>Any Type Reference</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.ow2.mindEd.adl.textual.fractal.FractalPackage#getTemplateReference_TemplatesList()
   * @model containment="true"
   * @generated
   */
   ...
   * @see org.ow2.mindEd.adl.textual.fractal.FractalPackage#getTemplateReference_ArgumentsList()
   * @model containment="true"
   * @generated
   */
