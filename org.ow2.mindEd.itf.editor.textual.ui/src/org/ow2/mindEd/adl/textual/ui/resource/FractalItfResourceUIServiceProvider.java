 ...
 * This class is used to enforce ITF-specific behavior:
 * We wish to filter files to make Xtext handle only
 * those that belong to our MindEd source-paths.
 */
public class FractalItfResourceUIServiceProvider extends
		DefaultResourceUIServiceProvider {

	@Inject
	public FractalItfResourceUIServiceProvider(IResourceServiceProvider delegate) {
		super(delegate);
	}
