...
protected class ThisRootNode extends RootToken {
	...
	public AbstractToken createFollower(int index, IInstanceDescription inst) {
		switch(index) {
			...
			case 27: return new ArgumentDefinition_Group(this, this, 27, inst);
			...
			case 37: return new AnnotationElement_Group(this, this, 37, inst);
 ...
 *   PrimitiveReferencesList? ("{" (elements+=AnnotationsList? elements+=
 *   PrimitiveDefinitionElement)* "}"|(elements+=AnnotationsList? elements+=
 ...
 *
 * ComponentTypeDefinition:
 *   "type" name=FullyQualifiedName referencesList=TypeReferencesList? ((elements+=
 *   AnnotationsList? elements+=TypeDefinitionElement)*|"{" (elements+=AnnotationsList?
